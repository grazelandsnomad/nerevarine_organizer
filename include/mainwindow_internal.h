...
// Nexus game domain for a profile - the <game> in nexusmods.com/<game>/mods/N.
// Usually the profile id itself, but a Skyrim AE profile must ask for
// skyrimspecialedition. Defined in mainwindow.cpp; used by the import TU when
// it has only the profile to go on (no mod URL to parse).
