...
// -- Importer parser ----------------------------------------------------
//
// parseConfigEntries underpins the "Import existing OpenMW setup" flow.
// Coverage stays narrow: data=/content=/groundcover= are preserved in
// encounter order, quotes around data= paths are stripped, comments and
// other keys are silently dropped, blank input is harmless.
...
// Tribunal/Bloodmoon, so a standalone Morrowind.esm replacer mod won't
// trip it.
