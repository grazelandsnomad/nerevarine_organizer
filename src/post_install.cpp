...
// Named grass mods whose folder/title contains neither "grass" nor
// "groundcover".  Extend as new ones become popular.
...
QString findSplashDir(const QString &modRoot)
{
    ...
    // The mod root itself is a Splash dir (case-insensitive).
    ...
    // Otherwise breadth-first search up to depth 3 for a splash/ subdir with
    // at least one image.
